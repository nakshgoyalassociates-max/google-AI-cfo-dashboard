...
export const COMPLIANCE_MASTER_LIST: ComplianceItem[] = [
  // ================= GST (10 Items) =================
  {
    ...
    dueDates: ['2026-09-11', '2026-10-13'],
    type: 'Return',
  ...
  },
  {
    ...
    dueDates: ['2026-09-20', '2026-09-22', '2026-09-24'],
    type: 'Return + Payment',
  ...
  },
  {
    ...
    dueDates: ['2026-07-31', '2026-10-31', '2027-01-31', '2027-05-31'],
    type: 'Return',
  ...
  },
  {
    ...
    dueDates: ['2026-07-15', '2026-10-15', '2027-01-15', '2027-05-15'],
    type: 'Return',
    penaltyClause: 'Late fee ₹200/day + penalty',
    period: 'Q2 FY 26-27',
    criticality: 'Medium',
  ...
  // ================= Income Tax (4 Items) =================
  {
    ...
    dueDates: ['2026-06-15', '2026-09-15', '2026-12-15', '2027-03-15'],
    type: 'Payment',
  ...
  },
  {
    ...
    dueDates: ['2026-07-31', '2026-10-31', '2026-11-30'],
    type: 'Return',
  ...
  },
  {
    ...
    dueDates: ['2026-04-30', '2026-10-31'],
    type: 'Filing',
  ...
  },
  {
    ...
    dueDates: ['2026-05-11', '2026-11-11'],
    type: 'Return',
  ...
  // ================= Professional Tax & State (3 Items) =================
  {
    ...
    dueDates: ['2026-09-20', '2026-09-30'],
    type: 'Payment + Return',
  ...
  },
  {
    ...
    dueDates: ['2026-01-15', '2026-07-15'],
    type: 'Payment',
